...
function postProcess
{
	...
	do
		...
		if [ "$headCnt" -eq 0 ]
			...
			# If partial year, trim results
			_month="${effD%%/*}"
			let currentMonth="$(echo $_month* 1|bc -l)"
